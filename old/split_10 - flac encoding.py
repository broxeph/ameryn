...
def split_file(input_filename, export_format='wav', bitrate='192k', tracks=None, artist='Unknown', album='Untitled', cover=None):
    ...
    for marker_num, marker in enumerate(file_markers):
        ...
        if export_format is not 'wav':
            ...
            mp3_fname = os.path.splitext(region_name)[0] + '.' + export_format
