...
input_filename = '1s_new.wav'
input_filename_list_range = range(228, 229)
input_filename_list = []
input_path = 'C:\Users\Alex\Google Drive\Ameryn\WTUL\Scripts\\tracky temp'
output_path = 'C:\Users\Alex\Google Drive\Ameryn\WTUL\Scripts\\tracky temp'
...
def split_file(input_filename):
    ...
    #test
    print file_markers[0], file_markers[-1], ifile.getnframes()
    #
    ...
    print 'New markers:', file_markers
    ...
    for marker_num, marker in enumerate(file_markers):
        ...
        region.length = file_markers[marker_num + 1] - marker
        print 'Region', marker_num, '@', region.length/44100.0, '->', region_name
