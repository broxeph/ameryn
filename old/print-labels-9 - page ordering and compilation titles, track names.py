...
def make_back_pdf(item_list):
    def add_back_cover(position):
        ...
        for size, padding in [(11,2), (11,1), (10,2), (10,1), (9,1), (9,0), (8,0), (8,-1), (7,-1), (7,-2), (6, -1), (6,-2)]:
            ...
            if item.compilation_counter == 1:
                compilation_tracks = []
                for each_item in [each_item for each_item in item_list if each_item.compilation_counter and each_item.order == item.order]:
                    for track in each_item.tracks:
                        track_title = '{0} - {1}'.format(item.artist, track)
                        compilation_tracks.append(track_title)
