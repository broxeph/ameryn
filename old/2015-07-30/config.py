...
log_level = c.get('general', 'log_level')
pool_processing = c.get('general', 'pool_processing')
drive_client_email = c.get('general', 'drive_client_email')
drive_private_key = c.get('general', 'drive_private_key')
base_url = c.get('general', 'base_url')

input_orders = c.get('input', 'input_orders')
input_items = c.get('input', 'input_items')
...
serial_series_start = c.getint('split', 'serial_series_start')
serial_series_end = c.getint('split', 'serial_series_end')
serial_series = range(serial_series_start, serial_series_end)
input_resplit_list = c.getboolean('split', 'input_resplit_list')
split_export_format = c.get('split', 'split_export_format')

digital_formats = c.get('print_labels', 'digital_formats')
