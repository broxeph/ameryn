...
# get an image
base = Image.open('D:/Sextus share/temp.jpg').convert('RGBA')
...
text_position = (draw_position[0] - textsize[0]/2, draw_position[1] - textsize[1]/2)
...
d.text(text_position, string, font=fnt, fill=(0,0,0,255))
