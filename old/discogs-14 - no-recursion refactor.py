...
def main():
    def add_serial_metadata(input_filename):
        ...
        with open(resplit_list_path, 'r') as resplit_list:
            ...
            for row in rowdata:
                ...
                if row_serial.zfill(5) == input_filename and row[1]:
    ...
    # Do the things
    while tries == 0 or runtime_errors and tries <= 5:
        if runtime_errors:
    ...
    # Done? Great!
    accuracy = round(matches_count / float(files_count), 3) * 100
