...
input_filename_list = []
input_path = 'C:\Users\Alex\Google Drive\Ameryn\WTUL\Scripts/tracky temp/big'
output_path = 'C:\Users\Alex\Google Drive\Ameryn\WTUL\Scripts/tracky temp/trackt'
silence_thresh = -45
...
def track_file(input_filename):
	...
	print 'audio.rms =', audio.rms,'=', audio.dBFS*2, 'dBFS'
