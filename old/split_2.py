...
f = 'c:/sextus share/temp audio/art tatum - the best of_clean.wav'
g = 'c:/sextus share/temp audio/test1a.wav'

def readmarkers(f, mmap=False):
    if hasattr(f,'read'):
        fid = f
    else:
        fid = open(f, 'rb')
...
print 'Copying wav...'
g_rate, g_data = read(g)
write('c:/sextus share/temp audio/test1b.wav', g_rate, g_data)